...
import Snapchat from '../styles/icons/snapchat'
	...
	<main className="Home">
		...
		<article className="mw6-ns center f3">
			<section>
				...
				<p className="mv4">
					I make small <Link href="/projects"><a className="link">side projects</a></Link> of all kinds in my free time,
					and work
			...
			<ul className="list mv4">
				...
				<li>
					<a className="link" href="https://snapchat.com/add/immatthamlin">
						<Snapchat className="mr2 v-mid yellow" />
						Snapchat
					</a>
				</li>
			</ul>
