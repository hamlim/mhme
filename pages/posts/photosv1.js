...
export default class extends Component {
  images = [
    ...
    },
    {
      ...
      lowres: '/static/images/posts/Photosv1/classic_apartment_buildings lowres.jpg',
    ...
    return (
      <Wrapper>
        ...
        <header>
          ...
          <p>
            The below photos were all taken on my Google Pixel XL with HDR+ mode on auto. I really love the camera on
            this phone so far, and I am really excited about the photos and videos I will be able to take with it!
          </p>
        </header>
